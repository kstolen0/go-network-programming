...
/**
A client can read variable length data using the type-length-value (TLV) encoding protocol.
TLV uses a fixed number of bytes to represent the type of data.
